...
public class MyApplication extends Application {
    ...
    public void onCreate() {
        super.onCreate();
        customers.add(new Customer(123, "archit", "123456", "1234"));
        ...
        accounts.add(new Account(1234, 123, "emailtoarchit@gmail.com",1000, "Joint"));
        accounts.add(new Account(1235, 123, "emailtoarchit@gmail.com",2000, "Saving"));
        ...
        accounts.add(new Account(1239, 345, "shobhashananency@gmail.com",3000, "Saving"));
        accounts.add(new Account(1240, 456, "emailtonency@gmail.com",2500, "Joint"));
    }
}
